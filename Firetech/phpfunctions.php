...
$results = array('error' => false, 'data' => '');
        ...
        $sql3="update _cplshipmentlines set cost=  (case when cb.calcbase='volume' then nullif(volume,0)/nullif(tot,0)*ce.rate when cb.calcbase='weight' then weight/nullif(totweight,0)*ce.rate when cb.calcbase='FOB' then 
