<?php
        ...
        include("config.php");
          ...
          $query = $_POST['id'];
            ...
            where 
            _cplshipmentmaster.id=$query and cr.cost='Entry_Amendment_Charges'
            ...
            where ttr.id=$query and cr.cost='Entry_Amendment_Charges'
            ...
            join _cplcostmaster cr on ts.costcode=cr.id
            where tr.id=cast($query as int)  and ts.active='True' and cr.cost='Entry_Amendment_Charges'";
