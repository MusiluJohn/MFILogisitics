<?php
        ...
        include("config.php");
          ...
          $query = $_POST['id'];
            ...
            where 
            _cplshipmentmaster.id=$query and cr.cost='Duty' and ServiceItem<>1 and calc_duty=1
            ...
            where ttr.id=$query and cr.cost='Duty' and serviceitem<>1
            ...
            select invoicelineid,code,cost,$amt*case when (cost)='Duty' then nullif(sum(fobamt),0) else nullif(0,0) end as swift
            into #rates
            from #tmpamts 
