<?php
        ...
        sum(case when cr.cost='BreakBulkCharges' then 0.16*cs.cost else 0 end)+
        sum(case when cr.cost='Entry_Amendment_Charges' then 0.16*cs.cost else 0 end)) as vatonhandling
        into #vatonhandling
        from stkitem st
