...
/****** Object:  StoredProcedure [dbo].[supplier_creditnotes]    Script Date: 2023/08/27 16:43:24 ******/
SET ANSI_NULLS ON
GO
...
ALTER PROCEDURE [dbo].[supplier_creditnotes]
...
BEGIN
	...
	select autoidx, b.account, b.Name as Supplier, b.Registration as Pin, '' as PI_no,
	reference as 'InvNo', format(txdate,'yyyy-MM-dd') as 'InvDate', 16 as vat, a.tax_amount as Inv_Vat,
