...
//close shipment
$closeship="declare @tot int

set @tot= (select count(isnull(rec_qty,0)) from _cplshipmentlines 
a join _cplshipmentmaster b on a.shipment_no=b.shipment_no
where b.id=$id and isnull(rec_qty,0)=0)

if @tot=0 
BEGIN
	update _cplshipmentlines set active=0 from _cplshipmentlines a
