<script type="text/javascript">
    $(function() {
       ...
       var TotalValuesk=0;var TotalValuecc=0; var TotalValueocs=0;
       ...
       $("tr #otherkes").each(function(index,value){
         currentRowocs = parseFloat($(this).text());
         TotalValueocs += currentRowocs
       });

       document.getElementById('otherkestot').innerHTML = TotalValueocs.toFixed(2);
