<?php
        ...
        include("config.php");
          ...
          $query = $_POST['id'];
            ...
            join _cplcostmaster cr on _cplshipmentlines.costcode=cr.id
            where 
            _cplshipmentmaster.id=$query and cr.cost='Disbursement'
            ...
            where ttr.id=$query and cr.cost='Disbursement'
            ...
            join _cplcostmaster cr on ts.costcode=cr.id
            where tr.id=cast($query as int)  and ts.active='True' and cr.cost='Disbursement'";
