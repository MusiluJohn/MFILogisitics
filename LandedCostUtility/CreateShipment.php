...
$('#update').click(function(){         
                    $.ajax({
                            ...
                            ,pickupno: $('#pickupno').val(),lcno: $('#lcno').val(),lcdate: $('#lcdate').val(),lcbank: $('#lcbank').val()
                            ,gbprate: $('#gbprate').val(),dutypaid: $('#payduty').val(),dateduty: $('#dateduty').val()},
...
<table style="margin-left:60px;">
    ...
    <td style='width:100px;'><input name='shipno' placeholder='Enter shipment no' id='shipno' class='form-control' type='text' required /></td></td></tr>
    </form>    
    </div>
    </div>
    <tr><td style='width:100px;'><label style='margin-top:10px;'>Mode of Transport: </label></td>
    <td><select name='mode' id='mode' class='form-select' style='margin-top:10px;height:30px;' >
    <option hidden>Select mode</option><option>Air</option><option>Sea</option><option>Courier</option>
    </select></td></tr>
    ...
    <input name='portdate' id='portdate' type='date' class='form-control' style='margin-top:10px;'required/></td></tr>
    <tr><td style='width:100px;'><label style='margin-top:10px;'>ETA @ Office*: </label></td><td>
    <input name='officedate' id='officedate' type='date'  class='form-control' style='margin-top:10px;' required/></td></tr>
    <tr><td style='width:100px;'><label style='margin-top:10px;'>Actual Arrival  @ Port: </label></td><td>
    <input name='arrdate' id='arrdate' type='date'  class='form-control' style='margin-top:10px;'/></td></tr>
    <tr><td style='width:100px;'><label style='margin-top:10px;'>Custom Entry No.: </label></td><td>
    <input name='customno' id='customno' value=0 class='form-control' style='margin-top:10px;' required/></td></tr>
    <tr><td style='width:100px;'><label style='margin-top:10px;'>Custom Entry Date: </label></td><td>
    <input name='customdate' id='customdate' class='form-control' type='date' style='margin-top:10px;' required/></td></tr>
    <tr><td style='width:100px;'><label style='margin-top:10px;'>Custom Pass Date: </label></td><td>
    <input name='passdate' id='passdate' class='form-control' type='date' style='margin-top:10px;'/></td></tr>
    ...
    <select name='clagent' id='clagent'  class='form-select' style='margin-top:10px;height:30px;'>
    <option hidden>Select clearing agent</option>
    <option>BESTFAST CARGO(KENYA) LTD</option><option>UNICARGO GLOBAL LOGISTICS LTD</option>
    <option>INDUS LOGISTICS LTD</option><option>ARAMEX KENYA LTD</option>
    <option>DHL WORLD WIDE EXPRESS</option>
    </select></td></tr>
    <tr><td style='width:100px;'><label style='margin-top:10px;'>Status: </label></td><td>
    <select name='status' id='status' class='form-select' style='margin-top:10px;height:30px;'>
...
<table  style="margin-left:60px;">
    ...
    <input name='etddate' id='etddate' class='form-control' type='date' style='margin-top:10px;'/></td></tr>
    <tr><td style='width:100px;'><label style='margin-top:10px;'>Payment Status: </label></td><td>
    <select name='paystatus' id='paystatus' class='form-select' style='margin-top:10px;height:30px;'>
    <option hidden>Select payment status</option>
    <option>UNPAID</option><option>PAID</option><option>Advance payment</option>
    <option>150Days LC</option><option>90Days LC</option>
    <option>60Days LC</option><option>45Days LC</option>
    </select></td></tr>
    ...
    <input name='gbprate' value=0 id='gbprate' class='form-control' type='number'  style='margin-top:10px;'/></td></tr>
    ...
    <tr><td style='width:100px;'><label style='margin-top:10px;'>Port Charges KES: </label></td><td>
    ...
    <input name='mino' value=0 id='mino' class='form-control' style='margin-top:10px;'/></td></tr>
    <tr><td style='width:100px;'><label style='margin-top:10px;'>Main Supplier PI No.: </label></td><td>
    <input name='pino' value=0 id='pino' class='form-control' style='margin-top:10px;'/></td></tr>
    <!-- <tr><td style='width:100px;'><label style='margin-top:10px;'>Main Supplier PI Date: </label></td><td> -->
    <!-- <input name='pidate' id='pidate' class='form-control' type='date' style='margin-top:10px;'/></td></tr> -->
    ...
    <input name='pickupno' value=0 id='pickupno' class='form-control' style='margin-top:10px;'/></td></tr>
    </tr></td>
    <tr><td style='width:100px;'><label style='margin-top:10px;'>LC Number: </label></td><td>
    <input name='lcno' value=0 id='lcno' class='form-control' style='margin-top:10px;'/></td></tr>
    </tr></td>
    <tr><td style='width:100px;'><label style='margin-top:10px;'>LC Date: </label></td><td>
    <input name='lcdate' type='date' id='lcdate' class='form-control' style='margin-top:10px;'/></td></tr>
    </tr></td>
    <tr><td style='width:100px;'><label style='margin-top:10px;'>LC Bank: </label></td><td>
    <input name='lcbank' placeholder='Enter the name of the bank' type='text' id='lcbank' class='form-control' style='margin-top:10px;'/></td></tr>
    </tr></td>
    <tr><td style='width:100px;'><label style='margin-top:10px;'>Duty to Pay: </label></td><td>
    <input name='payduty' value=0 type='text' id='payduty' class='form-control' style='margin-top:10px;'/></td></tr>
    </tr></td>
    <tr><td style='width:100px;'><label style='margin-top:10px;'>Date to pay duty: </label></td><td>
    <input name='dateduty' type='date' id='dateduty' class='form-control' style='margin-top:10px;'/></td></tr>
    </tr></td>
    </table>
    <!--</div>--->
    </div>
