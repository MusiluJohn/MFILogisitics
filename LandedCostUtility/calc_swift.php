<?php
        ...
        where 
        _cplshipmentmaster.id=$query and cr.cost='TT_SWIFT_Charges'
        ...
        where ttr.id=$query and cr.cost='TT_SWIFT_Charges'
        ...
        join _cplcostmaster cr on ts.costcode=cr.id
        where tr.id=cast($query as int)  and ts.active='True' and cr.cost='TT_SWIFT_Charges'";
