...
$sql2="select Cost_type, cost,descr from #tmpcost";
...
if( $stmt === false) {
   ...
   while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
       ...
       <tr><td> <?php echo $row["Cost_type"] ;?></td>
            ...
            <td> <input id='description' name='description[]' value="<?php echo $row["descr"] ;?>" type='text' style='form-control'/></td>
            <td>
            <?php  
                include("config.php");
                ...
                if ($stmt2) {			 
                echo "<select id='supplier' name='supplier[]' class='form-control select2' style='width:250px;height:27px;'>";
