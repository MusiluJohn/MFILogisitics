<?php
        ...
        include("config.php");
          ...
          $query = $_POST['id'];
            ...
            where 
            _cplshipmentmaster.id=$query and cr.cost='COC_in_Ksh' and ServiceItem<>1
            ...
            where ttr.id=$query and cr.cost='COC_in_Ksh' and serviceitem<>1
            ...
            join _cplcostmaster cr on ts.costcode=cr.id join stkitem st on ts.stkcode=st.StockLink
            where tr.id=cast($query as int)  and ts.active='True' and cr.cost='COC_in_Ksh' and st.serviceitem<>1";
