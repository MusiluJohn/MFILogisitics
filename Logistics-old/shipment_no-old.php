...
<table id="cost_table" name="cost_table" class="table table-sm table-bordered table-striped table-hover" style='font-size:10px;'>
        <thead >
            <tr>
                <th hidden>id</th>
                <th>id</th>
            ...
            group by invoicelineid,code";
			 ...
			 if( $stmt === false) {
				...
				while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
                    ...
                    <td hidden><input class='form-control' style='width:100px;' type='number' id='shipid<?php echo $rows;?>' name='shipid<?php echo $rows;?>' value="<?php echo $row["id"] ;?>" ></td>
