<script type="text/javascript">
    $(function() {
       ...
       var TotalValue = 0;var TotalValuefb=0;var TotalValueta=0;var TotalValuetak=0;
       var TotalValuew = 0;var TotalValuei=0;var TotalValuer=0;var TotalValuetw=0;
       var TotalValueg=0;var TotalValueh=0;var TotalValuef=0;var TotalValuesw=0;
       ...
       var TotalValuets=0;var TotalValueus=0;var TotalValueins=0; var TotalValuetotkes=0;
       ...
       document.getElementById('totalqty').innerHTML = TotalValue.toFixed(2);

       $("tr #fob").each(function(index,value){
         currentRowfb = parseFloat($(this).text());
         TotalValuefb += currentRowfb
       });

       document.getElementById('fobtots').innerHTML = TotalValuefb.toFixed(2);

       $("tr #totamt").each(function(index,value){
         currentRowta = parseFloat($(this).text());
         TotalValueta += currentRowta
       });

       document.getElementById('totamount').innerHTML = TotalValueta.toFixed(2);

       $("tr #totamtkes").each(function(index,value){
         currentRowtak = parseFloat($(this).text());
         TotalValuetak += currentRowtak
       });

       document.getElementById('totamountkes').innerHTML = TotalValuetak.toFixed(2);
       ...
       $("tr #totweight").each(function(index,value){
         currentRowtw = parseFloat($(this).text());
         TotalValuetw += currentRowtw
       });

       document.getElementById('tweight').innerHTML = TotalValuetw.toFixed(2);

       $("tr #swifts").each(function(index,value){
         currentRowsw = parseFloat($(this).text());
         TotalValuesw += currentRowsw
       });

       document.getElementById('swiftc').innerHTML = TotalValuesw.toFixed(2);
       ...
       $("tr #totkes").each(function(index,value){
         currentRowtotkes = parseFloat($(this).text());
         TotalValuetotkes += currentRowtotkes
       });

       document.getElementById('totkestot').innerHTML = TotalValuetotkes.toFixed(2);
