		 ...
		 $results = array('error' => false, 'data' => '');
			 ...
			 if( $stmt === false) {
				...
				while( $row = sqlsrv_fetch_array( $stmt, SQLSRV_FETCH_ASSOC) ) {
					...
					<td><input type='number' min='0.00000001' style='width:90px;height:12.5px;' class='form-control' id='weight<?php echo $rows;?>' name='weight<?php echo $rows;?>' value="<?php echo $row["ufIIweight"] ?? 0;?>" /></td>
					<script>
